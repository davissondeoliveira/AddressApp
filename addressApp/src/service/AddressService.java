...
public class AddressService{
	...
	public ArrayList <AddressModel> getList() {
		...
		ArrayList <AddressModel> lObj = new ArrayList<AddressModel>();
	...
	//Get a list of all address entered by admin
		public ArrayList <AddressModel> getZipList() {
			...
			try {
		        ...
		        while (rs.next()) {
		        	...
		        	am.setId(rs.getInt("ID"));
		        	am.setZip(rs.getString("ZIP"));
		        	obj.append(Integer.toString(rs.getInt("ID")), am);
		        	lObj.add(am);
		        }
